                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                   <?php echo form_open("pm/C_Pm/create_transaksi"); ?>
                                       ...
                                       <input type="hidden" name="status_expired" type="text" value="2020-07-12" readonly>
...
<!-- 
                                        <div class="form-group">
                                         ...
                                         <input type="hidden" name="pm_id" value=" <?php echo $this->session->userdata('pm_id') ?>" class="form-control"  readonly>
                                        
                                        <!-- <div class="form-group" align="right">
                                            <input type="reset" values="reset" class="btn btn-danger">
                                            <input type="submit" values="print" class="btn btn-primary" >
                                        </div> -->
                                        <div class="form-group" align="right">

...
<?php $this->load->view('pm/Vm_Navbar');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <center><h1 class="page-header">Halaman Data Servis Pramuniaga</h1></center>
                </div>
            </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=site_url('pm/C_Pm/zoom_servis/'.$servis->nota);?>"><i class="glyphicon glyphicon-zoom-in" style="color: green;"></i></a>
                                        </td>
                                    </tr>
                                    <?php $no++; } ?>
                                </tbody>
